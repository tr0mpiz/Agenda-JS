    ...
    if( id_agenda == 0 ){
        ...
        try {
            ...
            if(sqlPacienteExiste.length > 0 ){
                ...
                const sqlAgenda = `INSERT INTO agenda (id_agenda,id_paciente, fecha_cita , fecha_fin_cita , proxima_cita, comentario_cita, color,primeravez) VALUES (0,${ultimoPaciente[0].ultimopaciente}, '${fecha_cita}', '${fecha_fin_cita}', '${proxima_cita}', '${comentario_cita}', '${color_agenda}' , ${isCheckboxChecked})`;
                const insertAgenda = await ejecutarConsulta(sqlAgenda);
